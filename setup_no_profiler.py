...
# extra = {'cxx': ['-std=c++11', '-fopenmp', '-DBUILD_WITH_EASY_PROFILER'], 'nvcc': ['-std=c++11', '-Xcompiler', '-fopenmp', '-DBUILD_WITH_EASY_PROFILER']}
# extra = {'cxx': ['-std=c++11','-g','-O0', '-fopenmp', '-DBUILD_WITH_EASY_PROFILER'], 'nvcc': ['-std=c++11', '-Xcompiler', '-fopenmp', '-DBUILD_WITH_EASY_PROFILER']}
