...
#block(name=zyhseg006_10_test, threads=10, memory=100000, subtasks=1, gpu=true, hours=200)
   source activate SparseConvNet
   TASK_NAME=zyhseg006_10_test
   ...
   --gamma 0.2 \
   --step_size 1000 \
   --checkpoint_file ./ckpts/${FROM_TASK_NAME}/Epoch325.pth \
   --checkpoint 0 \
   --snapshot 5 \
   --m 16 \
   --block_reps 1 \
